    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.PositiveIntegerField(choices=[(1, 'Text'), (2, 'Number'), (3, 'Single selection'), (4, 'Multi selection'), (5, 'Currency')], default=(1, 'Text'))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cr_on', models.DateTimeField(default=datetime.datetime(2020, 11, 24, 11, 44, 4, 62736, tzinfo=utc), verbose_name='created on')),
                ('beneficiary', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='insurance.beneficiary')),
                ('created_by', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='application_form_created_by', to=settings.AUTH_USER_MODEL)),
                ('edited_by', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='application_form_edited_by', to=settings.AUTH_USER_MODEL)),
                ('fields', models.ManyToManyField(blank=True, to='insurance.ProductField')),

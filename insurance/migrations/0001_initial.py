# Generated by Django 3.1.3 on 2020-11-23 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255, verbose_name='Наименование')),
                ('client_type', models.CharField(choices=[(1, 'Физическое лицо'), (2, 'Юридик лицо')], default=(2, 'Юридик лицо'), max_length=50, verbose_name='Тип клиента')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('input_type', models.CharField(choices=[(1, 'Text'), (2, 'Number'), (3, 'Single selection'), (4, 'Multi selection'), (5, 'Currency')], default=(1, 'Text'), max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contract_type', models.CharField(choices=[(1, 'Leasing'), (2, 'Loan')], default=(2, 'Loan'), max_length=20)),
